...
int main()
{
    mg::jpo::ComplexNumber<double> c1(3.3, 4.2);
    mg::jpo::ComplexNumber<double> c2(1.6, -2.5);
    mg::jpo::ComplexNumber<double> c3;
    ...
    mg::jpo::ComplexNumber<int> c4(5, 6);
    mg::jpo::ComplexNumber<int> c5(5, 6);
    mg::jpo::ComplexNumber<int> c6(1, 1);
